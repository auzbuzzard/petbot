...
from petbot.domain import SkillContext, VoicePort, VoiceProvider
from petbot.services.music.voice import DiscordVoicePort
...
class DiscordVoiceProvider(VoiceProvider):
