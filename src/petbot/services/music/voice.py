"""Discord implementation of :class:`~petbot.domain.ports.VoicePort`.
...
from petbot.domain import TrackFinishedCallback, VoicePort
...
class DiscordVoicePort(VoicePort):
