...
in :attr:`~petbot.domain.skill.Skill.requires` is only hosted by a service that can
...
class Capability(StrEnum):
    """A capability a service can *provide* and a skill can *require*."""

    #: A voice transport is available (the service can supply a ``VoicePort``).
    VOICE = "voice"
